...
public class EmployeeAPIIntegrationTest {
	...
	public void setUp() {
		...
		Employee emp=new Employee("suchi","tangut",45000,LocalDate.now(),Department.DEVELOPMENT,"9441027798","suchi12@gmail.com");
	...
	public void whenFindAll_thenReturnJsonArray() throws Exception {
		...
		.andExpect(jsonPath("$[0].mobileNumber",is("9441027798")));
	}
